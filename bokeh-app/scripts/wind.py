...
def wind_tab(source):
    ...
    def make_speed_plot(source):
        ...
        p.scatter('date', 'wind_speed', size=10, line_color='white', color='black', fill_alpha=0.9, source=source)
        p = style(p)
        return p
    ...
    def make_dir_plot(source):
        ...
        p.scatter('date', 'wind_dir', size=10, line_color='white', color='black', fill_alpha=0.9, source=source)
    ...
    def make_ustar_plot(source):
        ...
        p.scatter('date', 'u*', size=10, line_color='white', color='black', fill_alpha=0.9, source=source)
        p = style(p)
        return p
